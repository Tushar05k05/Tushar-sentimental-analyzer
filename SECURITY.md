...
To document a security concern, communication is facilitated with the project curators:
  - **Curator**: [Tushar](https://github.com/tushar)
  - **Collaborator**: [Tushar Satish](https://github.com/msatmod)
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/tushar/SENTIMENT-ANALYZER/issues) interface to formally record security-related findings.
